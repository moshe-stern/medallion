...
declare class SDK {
  ...
  api_v1_org_cme_credits_create_cmeCredits(
    ...
    FetchResponse<201, types.ApiV1OrgCmeCreditsCreateCmeCreditsResponse201>
  >;
  /**
   * Get a cme credit
   *
  ...
  api_v1_org_cme_credits_retrieve_cmeCredits(
    ...
    FetchResponse<200, types.ApiV1OrgCmeCreditsRetrieveCmeCreditsResponse200>
  >;
  /**
  ...
  ): Promise<FetchResponse<200, types.ApiV1OrgLicensesListLicensesResponse200>>;
  /**
  ...
  api_v1_org_licenses_partial_update_licenses(
    ...
    FetchResponse<200, types.ApiV1OrgLicensesPartialUpdateLicensesResponse200>
  >;
  /**
   * Get a license
   *
  ...
  api_v1_org_licenses_detail_partial_update(
    ...
    FetchResponse<200, types.ApiV1OrgLicensesDetailPartialUpdateResponse200>
  >;
  api_v1_org_licenses_detail_partial_update(
    metadata: types.ApiV1OrgLicensesDetailPartialUpdateMetadataParam,
  ): Promise<
  ...
  api_v1_org_licenses_history_list_licenses(
    ...
    FetchResponse<200, types.ApiV1OrgLicensesHistoryListLicensesResponse200>
  >;
  /**
  ...
  api_v1_org_licenses_bulk_history_list_licenses(
    ...
    FetchResponse<200, types.ApiV1OrgLicensesBulkHistoryListLicensesResponse200>
  >;
  /**
  ...
  api_v1_org_practices_retrieve_practices(
    ...
    FetchResponse<200, types.ApiV1OrgPracticesRetrievePracticesResponse200>
  >;
  /**
  ...
  api_v1_org_practices_partial_update_practices(
    ...
    FetchResponse<200, types.ApiV1OrgPracticesPartialUpdatePracticesResponse200>
  >;
  api_v1_org_practices_partial_update_practices(
    metadata: types.ApiV1OrgPracticesPartialUpdatePracticesMetadataParam,
  ): Promise<
  ...
  api_v1_org_providers_retrieve_providers(
    ...
    FetchResponse<200, types.ApiV1OrgProvidersRetrieveProvidersResponse200>
  >;
  /**
  ...
  api_v1_org_providers_partial_update_providers(
    ...
    FetchResponse<200, types.ApiV1OrgProvidersPartialUpdateProvidersResponse200>
  >;
  api_v1_org_providers_partial_update_providers(
    metadata: types.ApiV1OrgProvidersPartialUpdateProvidersMetadataParam,
  ): Promise<
  ...
  api_v1_org_providers_addresses_list_addresses(
    ...
    FetchResponse<200, types.ApiV1OrgProvidersAddressesListAddressesResponse200>
  >;
  /**
  ...
  api_v1_org_providers_exams_retrieve_exams(
    ...
    FetchResponse<200, types.ApiV1OrgProvidersExamsRetrieveExamsResponse200>
  >;
  /**
  ...
  api_v1_org_providers_trainings_list_trainings(
    ...
    FetchResponse<200, types.ApiV1OrgProvidersTrainingsListTrainingsResponse200>
  >;
  /**
  ...
  ): Promise<FetchResponse<200, types.PApiV1EmployeesListEmployeesResponse200>>;
  /**
   * Update an employee
   *
  ...
  p_api_v1_employees_partial_update_employees(
    ...
    FetchResponse<200, types.PApiV1EmployeesPartialUpdateEmployeesResponse200>
  >;
  p_api_v1_employees_partial_update_employees(
    metadata: types.PApiV1EmployeesPartialUpdateEmployeesMetadataParam,
  ): Promise<
  ...
  p_api_v1_facilities_retrieve_facilities(
    ...
    FetchResponse<200, types.PApiV1FacilitiesRetrieveFacilitiesResponse200>
  >;
  /**
  ...
  p_api_v1_facilities_partial_update_facilities(
    ...
    FetchResponse<200, types.PApiV1FacilitiesPartialUpdateFacilitiesResponse200>
  >;
  p_api_v1_facilities_partial_update_facilities(
    metadata: types.PApiV1FacilitiesPartialUpdateFacilitiesMetadataParam,
  ): Promise<
  ...
  p_api_v1_group_profiles_list_groupProfiles(
    ...
    FetchResponse<200, types.PApiV1GroupProfilesListGroupProfilesResponse200>
  >;
  /**
  ...
  p_api_v1_group_profiles_create_groupProfiles(
    ...
    FetchResponse<201, types.PApiV1GroupProfilesCreateGroupProfilesResponse201>
  >;
  /**
  ...
  p_api_v1_organizations_invites_list_invites(
    ...
    FetchResponse<200, types.PApiV1OrganizationsInvitesListInvitesResponse200>
  >;
  /**
   * Create a new Invite
   *
  ...
  p_api_v1_organizations_invites_create_invites(
    ...
    FetchResponse<201, types.PApiV1OrganizationsInvitesCreateInvitesResponse201>
  >;
  /**
  ...
  p_api_v1_organizations_members_list_members(
    ...
    FetchResponse<200, types.PApiV1OrganizationsMembersListMembersResponse200>
  >;
  /**
  ...
  p_api_v1_organizations_members_create_members(
    ...
    FetchResponse<201, types.PApiV1OrganizationsMembersCreateMembersResponse201>
  >;
  /**
   * Get a Membership
   *
